...
# generate all smaller instances (100/customers)

# echo "Calling generate_instancePKL_each_100_customers.py"
# python generate_instancePKL_each_100_customers.py



echo "Exporting Heatmaps"
# export heatmap of all smaller instances (grouped by the main instance)
...
do
	echo $instance
	mkdir -p results/vrp/${instance}/heatmaps/
	
	CUDA_VISIBLE_DEVICES=0,0 python export_heatmap.py --problem vrp --checkpoint logs/vrp_uchoa100/best_val_loss_checkpoint.tar --instances data/vrp/${instance}.pkl -f -o results/vrp/${instance}/heatmaps/${instance}.pkl --batch_size 1
done


cd ..
# echo "Calling convert_heatmapsPKL_to_readable.py"
# # convert all heatmaps to ".hm" format
# python convert_heatmapsPKL_to_readable.py
