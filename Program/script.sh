...
do
    ...
    # timeLimit=10
    ./genvrp-eax ../Instances/CVRP/${instances[$index]}.vrp Solutions/${instances[$index]}-eax.sol -seed 1 -t $timeLimit & 
    ./genvrp-ox ../Instances/CVRP/${instances[$index]}.vrp Solutions/${instances[$index]}-ox.sol -seed 1 -t $timeLimit &
    wait;
done