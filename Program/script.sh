...
seed=1
./genvrp ../Instances/CVRP/${instance}.vrp testes/${instance}_seed${seed}.sol -seed $seed -t ${time} > testes/output_${instance}_seed${seed}.txt  &
seed=2
./genvrp ../Instances/CVRP/${instance}.vrp testes/${instance}_seed${seed}.sol -seed $seed -t ${time} > testes/output_${instance}_seed${seed}.txt &
seed=3
./genvrp ../Instances/CVRP/${instance}.vrp testes/${instance}_seed${seed}.sol -seed $seed -t ${time} > testes/output_${instance}_seed${seed}.txt &
...
#     ./genvrp-eax ../Instances/CVRP/${instances[$index]}.vrp Solutions/${instances[$index]}-eax.sol -seed 1 -t $timeLimit > Solutions/output_eax_${instances[$index]}.txt &
#     # ./genvrp-ox ../Instances/CVRP/${instances[$index]}.vrp Solutions/${instances[$index]}-ox.sol -seed 1 -t $timeLimit > Solutions/output_ox_${instances[$index]}.txt &
#     echo $external_index
#     if (( external_index % 6 == 0)) ; then
#         echo "waiting"
#         wait;
#     fi
