...
# Uncomment all desired lines

# unzip LKH-3.0.6.zip
# cp execute-lkh-CC-2step.sh LKH-3.0.6/

# cp run_experiments.pbs LKH-3.0.6/
...
#     do
#         touch params_${instance}_seed${seed}.txt
#         echo "PROBLEM_FILE = ../../../Instances/CVRP/${instance}.vrp" >> params_${instance}_seed${seed}.txt
#         echo "SPECIAL" >> params_${instance}_seed${seed}.txt
#         echo "MAX_TRIALS = 100000" >> params_${instance}_seed${seed}.txt
#         echo "SEED = ${seed}" >> params_${instance}_seed${seed}.txt
#         echo "RUNS = 1" >> params_${instance}_seed${seed}.txt
#         echo "TIME_LIMIT = 5" >> params_${instance}_seed${seed}.txt
#         echo "OUTPUT_TOUR_FILE = OUTPUT_TOUR_FILE/${instance}_seed${seed}.txt" >> params_${instance}_seed${seed}.txt
#         echo "TOUR_FILE = TOUR_FILE/${instance}_seed${seed}.txt" >> params_${instance}_seed${seed}.txt
#         echo "EOF" >> params_${instance}_seed${seed}.txt

#         qsub -V -v ARGS="./LKH params_${instance}_seed${seed}.txt",OUTPUT="output_LKH/stdout_${instance}_seed${seed}.txt" run_experiments.pbs
