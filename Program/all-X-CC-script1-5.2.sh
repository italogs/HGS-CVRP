...
do
    sbatch --export=instance=${instances[$index]},batch_size=${batches_size[$index]},timeClassic=${instances_time[$index]},timeReduced=${instances_time_reduced[$index]} all-X-CC-script2-5.2.sh
done
