...
# Crossover "learning-based OX"
external_index=0
for instance in "${instances[@]}"
do
    sbatch --export=instance=${instance},time=${instances_time[$external_index]},crossover=3 exec-grid.sh
...
for instance in "${instances[@]}"
do
    sbatch --export=instance=${instance},time=${instances_time[$external_index]},crossover=1 exec-grid.sh
    external_index=$((external_index+1))
done
